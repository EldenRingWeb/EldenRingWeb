...
function getEldenRingData(name) {
    fetch("https://eldenring.fanapis.com/api/classes?name=" + name)
        ...
        .then(response => {
            ...
            document.getElementById('btn').textContent = response.data[0].name;
    ...
    const discoverarray = [101, 102, 103,
        104,
        105,
        106,
        107,
...
function levelCalc() {
    ...
    document.getElementById('runes1').textContent = levelarray.length;
}
    ...
    for(let i = 0; i < 5; i++) {
        fetch("https://eldenring.fanapis.com/api/weapons?limit=100&page=" + i)
            ...
            .then(response => {
                if (i < 3) {
                    for(let j = 0; j < 100; j++) {
                    weaponarray.push(response.data[j].name);
                    } 
                } 
                if (i > 2) {
                    for(let k = 0; k <= 6; k++) {
                        weaponarray.push(response.data[k].name);
...
function weaponStats() {
    fetch("https://eldenring.fanapis.com/api/weapons?limit=100&page=" + document.querySelector('button').textContent)
        .then(data => data.json())
        .then(response => {
            for (let i = 0; i < weaponarray.length; i++) {
                if (response.data[i].name === document.getElementsByName('button').textContent) {
                    console.log('hello');
                }
            }
    });
...
// const reccomendarray = [];
// const namearray = [];

// function reccomendClass() {
//     fetch("https://eldenring.fanapis.com/api/classes")
//         .then(data => data.json())
//         .then(response => {
//             for (let i = 0; i < reccomendarray.length; i++) {
//                 delete reccomendarray[i];
//             }
//             for (let i = 0; i < 11; i++) {
//                 if (document.querySelectorAll(".input").value != document.querySelectorAll(".input").min) {
//                     var level = document.querySelector("#level").value - response.data[i].stats.level;
//                     var vigor = document.querySelector(".vigor").value - response.data[i].stats.vigor;
//                     var mind = document.querySelector(".mind").value - response.data[i].stats.mind;
//                     var endurance = document.querySelector(".endurance").value - response.data[i].stats.endurance;
//                     var strength = document.querySelector(".strength").value - response.data[i].stats.strength;
//                     var dexterity = document.querySelector(".dexterity").value - response.data[i].stats.dexterity;
//                     var intelligence = document.querySelector(".intelligence").value - response.data[i].stats.inteligence;
//                     var faith = document.querySelector(".faith").value - response.data[i].stats.faith;
//                     var arcane = document.querySelector(".arcane").value - response.data[i].stats.arcane;
//                     var sum = vigor + mind + endurance + strength + dexterity + intelligence + faith + arcane;
//                     reccomendarray.push(sum);
//                     namearray.push(response.data[i].name);
//                     console.log(document.querySelectorAll(".input").value);
//                 }
                
//             }
//             var min = Math.min(...reccomendarray);
//             for (let i = 0; i < reccomendarray.length; i++) {
//                 if (reccomendarray[i] === min) {
...
// function reccomendedClass() {
//     document.querySelector(".vigor").value = 9;
//     document.querySelector(".vigor").min = 9;

//     document.querySelector(".mind").value = 9;
//     document.querySelector(".mind").min = 9;

//     document.querySelector(".endurance").value = 8;
//     document.querySelector(".endurance").min = 8;

//     document.querySelector(".strength").value = 8;
//     document.querySelector(".strength").min = 8;

//     document.querySelector(".dexterity").value = 8;
//     document.querySelector(".dexterity").min = 8;

//     document.querySelector(".intelligence").value = 7;
//     document.querySelector(".intelligence").min = 7;

//     document.querySelector(".faith").value = 6;
//     document.querySelector(".faith").min = 6;

//     document.querySelector(".arcane").value = 7;
//     document.querySelector(".arcane").min = 7;

//     document.querySelector("#slider1").value = 9;
//     document.querySelector("#slider1").min = 9;

//     document.querySelector("#slider2").value = 9;
//     document.querySelector("#slider2").min = 9;

//     document.querySelector("#slider3").value = 8;
//     document.querySelector("#slider3").min = 8;

//     document.querySelector("#slider4").value = 8; 
//     document.querySelector("#slider4").min = 8; 

//     document.querySelector("#slider5").value = 8; 
//     document.querySelector("#slider5").min = 8; 

//     document.querySelector("#slider6").value = 7; 
//     document.querySelector("#slider6").min = 7; 

//     document.querySelector("#slider7").value = 6;
//     document.querySelector("#slider7").min = 6;
    
//     document.querySelector("#slider8").value = 7; 
//     document.querySelector("#slider8").min = 7; 
// }
...
function softCapColours() {
    ...
    if (parseInt(document.querySelector(".intelligence").value) >= 20 && parseInt(document.querySelector(".intelligence").value) < 55) {
        ...
        var intelligence= document.querySelector(".intelligence")
        intelligence.style.color = "black"
    }
    ...
    if (parseInt(document.querySelector(".arcane").value) >= 20 && parseInt(document.querySelector(".arcane").value) < 55) {
        ...
        var arcane= document.querySelector(".arcane")
        arcane.style.color = "black"
    }
}

function headArmour(headname){
        fetch("https://eldenring.fanapis.com/api/armors?name=" + headname)
            .then(data => data.json())
            .then(response => {
                document.getElementById('imginput1').src = response.data[0].image;
                document.getElementById('imginput1').style.width = "125px";
                document.getElementById('imginput1').style.marginLeft = "28%";
                document.getElementById('imginput1').style.marginTop = "15px";
        });
}
